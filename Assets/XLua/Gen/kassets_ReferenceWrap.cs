...
namespace XLua.CSObjectWrap
{
    ...
    public class kassetsReferenceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(kassets.Reference);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					kassets.Reference gen_ret = new kassets.Reference();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to kassets.Reference constructor!");
        ...
        static int _m_IsUnused(RealStatePtr L)
        {
		    try {
                ...
                kassets.Reference gen_to_be_invoked = (kassets.Reference)translator.FastGetCSObj(L, 1);
