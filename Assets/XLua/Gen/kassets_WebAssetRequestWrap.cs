...
namespace XLua.CSObjectWrap
{
    ...
    public class kassetsWebAssetRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(kassets.WebAssetRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					kassets.WebAssetRequest gen_ret = new kassets.WebAssetRequest();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to kassets.WebAssetRequest constructor!");
        ...
        static int _g_get_text(RealStatePtr L)
        {
		    try {
                ...
                kassets.WebAssetRequest gen_to_be_invoked = (kassets.WebAssetRequest)translator.FastGetCSObj(L, 1);
